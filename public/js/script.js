(function() {
    Vue.component("first-component", {
        ...
        methods: {
            ...
            submitComment: function() {
                console.log("Submit comment runs");
                var myVue = this;
                let commentContent = {
                ...
                axios.post("/comment", commentContent).then(function(resp) {
                    console.log("response for comments", resp);
    ...
    new Vue({
        ...
        methods: {
            ...
            moreImages: function() {
                var myVue = this;
                console.log("Estas imágenes", this.images);
                let lastId = this.images.slice(-1)[0].id; // This is the smaller,lastId shown,
                console.log(lastId);
                axios.get(`/moreimages/${lastId}`).then(function(res) {
                    console.log("After clicking in more button", res);
